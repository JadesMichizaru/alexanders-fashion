...
<body class="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500">
    <div class="w-full max-w-md bg-white/80 dark:bg-gray-900/80 rounded-2xl shadow-xl px-8 py-10 backdrop-blur-md">
        ...
        <div class="mb-4 text-center">
            ...
            <p class="text-sm text-gray-600 dark:text-gray-400">Log in to your account to continue</p>
        </div>
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-5">
            ...
            <div class="flex items-center justify-between">
                <a href="{{ route('register') }}" class="text-sm font-semibold text-indigo-600 dark:text-indigo-400 hover:underline hover:text-indigo-700 dark:hover:text-indigo-300 transition">
